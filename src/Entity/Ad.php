...
class Ad
{
    ...
    /**
     * Permet de récupérer le commentire d'un auteur par rapport à une annonce
     *
     * @param User $author
     * @return Comment|null
     */
    ...
    /**
     * Permet d'obtenir un tableau des jours qui ne sont pas disponnibles pour cette annonce
     *
